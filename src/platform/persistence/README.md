...
`src/platform/persistence/` owns checkpoint answer encoding, sanitization, resume logic, and step-access guards.
...
Preserve cookie names and payload compatibility unless a migration is explicit. Add route tests for any guard or resume behavior change.
