...
const productionClassTokenMap = {
  ...
  "consent-scroll": "bi",
  "consent-scroll-fade-top": "bj",
  "consent-scroll-fade-bottom": "bk",
  "consent-scroll-fade": "bl",
  "consent-scroll-shell": "bm",
  "area-pill": "i",
  "brand-identity": "j",
  "brand-logo": "k",
  "brand-trust": "l",
  ...
  "button-label": "bb",
  "button-spinner": "bc",
  "trusted-form-review-scroll-shell": "bd",
  "trusted-form-review-scroll-fade-top": "be",
  "trusted-form-review-scroll-fade-bottom": "bf",
  "trusted-form-review-scroll-fade": "bg",
  button: "p",
  "error-modal-close": "q",
